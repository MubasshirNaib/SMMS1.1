...
public class ODashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jDesktopPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 170, 330, 230));
        ...
        btnedit.setFont(new java.awt.Font("Imprint MT Shadow", 1, 20)); // NOI18N
        ...
        btndelete.setFont(new java.awt.Font("Imprint MT Shadow", 1, 20)); // NOI18N
        ...
        btnupload.setFont(new java.awt.Font("Imprint MT Shadow", 1, 20)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtphoto2, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtphoto2, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnupload))
                .addGap(15, 15, 15)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnadd)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 440, 440));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 410, 120, 40));
        ...
        Table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Mess id", "Details", "Locations", "Fees", " Facilities", "Photo"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 10, 460, 150));
        ...
        setSize(new java.awt.Dimension(951, 497));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents
        Connection con1,con2;
        PreparedStatement insert,push,insert1,insert2;
   ...
   // String tc;
    private void Table1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table1MouseClicked
      ...
      //  int row=Table1.getSelectedRow();
       ...
       String tc=Table1.getModel().getValueAt(selectedIndex, 1).toString();
        ...
        try{
         ...
         txtousername1.setText(Df.getValueAt(selectedIndex, 0).toString());
        //  tc=Table1.getModel().getValueAt(selectedIndex, 1).toString();
         txtoid.setText(Df.getValueAt(selectedIndex, 1).toString());
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(username.isEmpty()||password.isEmpty()||id.isEmpty()||details.isEmpty()||location.isEmpty()||fees.isEmpty()||facilities.isEmpty()){
            ...
            ResultSet res = insert.executeQuery();
            if(res.next()){
                insert1 = con1.prepareStatement("update record set details= ?,location= ?,fees= ?,facilities= ? where id= ?");
          //  insert1.setString(1,id);
            ...
            insert1.setString(5,id);
           // insert1.setBytes(6,photo);
...
private ImageIcon format;
    ...
    private void FetchPhoto() {
       int row=Table1.getSelectedRow();
       int vv=Table1.getSelectedColumn();
       String tc=Table1.getModel().getValueAt(row, 0).toString();
