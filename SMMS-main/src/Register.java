...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtobanking = new javax.swing.JTextField();
        btnoregister = new javax.swing.JButton();
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 510, 180, 40));
        ...
        btnsregister.setFont(new java.awt.Font("Berlin Sans FB", 0, 24)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtspassword, javax.swing.GroupLayout.DEFAULT_SIZE, 233, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(3, 3, 3)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnsregister, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtsaddress, javax.swing.GroupLayout.DEFAULT_SIZE, 235, Short.MAX_VALUE)
                                .addComponent(txtsmobile)
                                .addComponent(txtsemail)
                                .addComponent(txtsbanking)))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel16)
                    .addComponent(txtsmobile, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel17)
                    .addComponent(txtsbanking, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
        ...
        txtopassword.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtopasswordActionPerformed(evt);
            }
        });
        ...
        txtoemail.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtoemailActionPerformed(evt);
            }
        });
        ...
        btnoregister.setFont(new java.awt.Font("Berlin Sans FB", 0, 24)); // NOI18N
        btnoregister.setText("Register");
        btnoregister.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnoregisterActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(11, 11, 11)
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtoaddress, javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(txtoemail)))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(12, 12, 12)
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtousername, javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(txtopassword, javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(txtoid)))))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGap(9, 9, 9)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtomobile)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(btnoregister, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))
                                    .addComponent(txtobanking)))))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        .addGap(22, 22, 22)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(txtomobile, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel11)
                    .addComponent(txtobanking, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
                .addComponent(btnoregister)
                .addContainerGap(43, Short.MAX_VALUE))
        );
    ...
    private void txtoemailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtoemailActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtoemailActionPerformed

    private void txtopasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtopasswordActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtopasswordActionPerformed
    ...
    private void btnoregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnoregisterActionPerformed
        // TODO add your handling code here:
        String id =txtoid.getText();
        String username =txtousername.getText();
        String password =txtopassword.getText();
        String mobile =txtomobile.getText();
        String address =txtoaddress.getText();
        String banking =txtobanking.getText();
        String email =txtoemail.getText();
        if(username.isEmpty()||password.isEmpty()||banking.isEmpty()||password.isEmpty()||mobile.isEmpty()||address.isEmpty()||email.isEmpty()){
            ...
            txtoid.setText("");
            txtopassword.setText("");
            txtomobile.setText("");
            txtoaddress.setText("");
            txtobanking.setText("");
            txtoemail.setText("");
            txtousername.requestFocus();
    ...
    }//GEN-LAST:event_btnoregisterActionPerformed
       Connection con1;
    ...
    private javax.swing.JButton btnoregister;
    ...
    private javax.swing.JTextField txtobanking;
